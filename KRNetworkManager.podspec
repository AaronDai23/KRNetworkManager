#
#  Be sure to run `pod spec lint KRNetworkManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  对AFN进行二次封装,支持app复杂的网络处理                  
 DESC

  spec.homepage     = "https://github.com/AaronDai23/KRNetworkManager.git"
  ...
  spec.license      = "MIT (KRNetworkManager)"
 ...
 # spec.platform     = :ios
  ...
  spec.source       = { :git => "https://github.com/AaronDai23/KRNetworkManager.git", :tag => "#{spec.version}" }
